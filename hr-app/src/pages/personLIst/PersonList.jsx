...
import { calculateYearsInService, schedulReminder, animalToEmoji } from "./PersonListFunctions";
import GetDepartmentImage from "../../components/Employees/DepartmentImages";
import './index.css'; 

const PersonList = ({ employeeData, onEdit }) => {
    return (
        <div>
                    ...
                    {employeeData.map((employee) => {
                        ...
                        return (
                            <div key={employee.id} className="message">
                                <PersonCard {...employee} reminderEmoji={reminderEmoji} animalEmoji={animalEmoji} yearsInService={yearsInService} departmentImage={departmentImage} onEdit={onEdit} />
                            </div>
                        );
                    })}
                </div>
