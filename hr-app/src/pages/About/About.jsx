...
function About() {
      ...
      <main>
        <div className="textField">
          ...
          <section className="sectionOne">
            <p>
              Welcome to the HR App!We strive to make managing employee data and
              department workflows simple and intuitive.Our goal is to empower
              HR professionals with the best tools to help their teams thrive.
            </p>
            <img
              src={aboutImage1}
              className="imageOne"
  ...
  `}
          ...
          <section className="sectionTwo">
            <div>
              <h4>Our Mission</h4>
              <p>
                To provide a seamless experience for managing employees,tracking
  ...
  `}
            ...
            <div>
              ...
              <p>
                We value collaboration and constant improvement.Join our growing
